...
@Service
public class GetTritianosWithTritianoLenguajeByIdUseCaseImpl implements GetTritianosWithTritianoLenguajesByIdUseCase {

    private final TritianosConTritianosLenguajesRepositoryPort tritianosConTritianosLenguajesRepositoryPort;

    public GetTritianosWithTritianoLenguajeByIdUseCaseImpl(TritianosConTritianosLenguajesRepositoryPort tritianosConTritianosLenguajesRepositoryPort) {
        this.tritianosConTritianosLenguajesRepositoryPort = tritianosConTritianosLenguajesRepositoryPort;
    }

    @Override
    @Transactional(readOnly = true)
    public List<TritianosConTritianosLenguajes> getTritianosWithTritianoLenguajesById(Long id) {
        return tritianosConTritianosLenguajesRepositoryPort.getTritianosWithTritianoLenguajesUseCaseById(id);
    }
