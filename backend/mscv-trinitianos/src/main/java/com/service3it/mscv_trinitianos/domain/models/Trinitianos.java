...
public class Trinitianos {
    ...
    public Trinitianos (Long id, String nombre, String apellido, String correoElectronico, String rut, String telefono, String estado, String enlaceBizneo, String enlaceHubspot, String enlaceJira, LocalDateTime fechaCreacion, LocalDateTime fechaModificacion) {
        this.id = id;
        this.nombre = nombre;
